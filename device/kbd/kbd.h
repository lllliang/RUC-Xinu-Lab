...
#define CURSOR_START_ADDR 0xB8000   // 光标起始地址 0xb8000
#define POS2ADDR(pos)     (CURSOR_START_ADDR + 2 * ((uint32)(pos))) // 一个字符对应2个字节
#define SET_CHAR(pos, c)  (*((uint32*)(POS2ADDR(pos))) = ((c & 0xff) | 0x0700))
#define NEXT_ROW_POS(pos) (pos - (pos % MAX_COL)) + MAX_COL   
